...
import { AllProducts, Menuuch } from '../../FakeApi'
        ...
        <>
            <div className="h-[100px]">
                <div className="container h-full flex items-center gap-3">
                    ...
                    <span className='text-[#bea087] text-[12px] md:text-[14px]'>/</span>
                    <Link className='font-light text-[12px] md:text-[14px]'>Барное меню</Link>
                </div>
            </div>
            <div className="flex items-center py-10">
                <div className="container">
                    ...
                    <div className="flex flex-wrap gap-4 my-4">
                        ...
                        <Link to={'/menu/suv'} className='text-[15px] px-5 py-2 rounded-3xl text-white bg-[#dcc38b]'>Барное меню</Link>
            ...
            <div className="flex items-center justify-center bg-[#bea087] py-5">
                <h1 className='text-3xl text-white'>БАРНОЕ МЕНЮ</h1>
            </div>
            <div className="my-20">
                <div className="container grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10">
                    {
                        Menuuch.map((item, index) => (
