...
export const Delivery = () => {
    const yangi = AllProducts.filter(item => item.type.includes('Доставка'))
    return (
        <>
            <div className="h-[100px]">
                <div className="container h-full flex items-center gap-3">
                    ...
                    <span className='text-[#bea087] text-[12px] md:text-[14px]'>/</span>
                    <Link to={'/menu/delivery'} className='font-light text-[12px] md:text-[14px]'>Доставка аниматором</Link>
                </div>
            </div>
            <div className="flex items-center py-10">
                <div className="container">
                    ...
                    <div className="flex flex-wrap gap-4 my-4">
                        ...
                        <Link to={'/menu/delivery'} className='text-[15px] px-5 py-2 rounded-3xl text-white bg-[#dcc38b]'>Доставка аниматором</Link>
                    </div>
                </div>
            </div>
            <div className="flex items-center justify-center bg-[#bea087] py-5">
                <h1 className='text-3xl text-white'>Доставка аниматором</h1>
            </div>
            <div className="my-10">
                <div className="container">
                    {
                        yangi.map((item, index) => (
                            <div key={index} className='text-center w-full md:w-1/4' >
